...
private:
    ...
    rev::CANSparkMax rearLeft{1, rev::CANSparkMax::MotorType::kBrushless};
    rev::CANSparkMax frontRight{2, rev::CANSparkMax::MotorType::kBrushless};
    rev::CANSparkMax rearRight{3, rev::CANSparkMax::MotorType::kBrushless};
    frc::MecanumDrive mecanumDrive{frontLeft, rearLeft, frontRight, rearRight}; 

    AHRS gyro{frc::SPI::Port::kMXP};    

    frc::DigitalInput lineSensor{0};
